...
function cabecera($fpdf, $conexion)
{
    ...
    $fpdf->Image('imagenes/logofactura.jpeg', 12, 1, 40, 45);
...
function titulosdetalle($fpdf)
{
    ...
    $fpdf->Cell(70, 10, 'Descripción', 1, 0, 'L', 1);
    $fpdf->Cell(20, 10, 'Cantidad', 1, 0, 'C', 1);
    $fpdf->Cell(40, 10, 'Precio', 1, 0, 'R', 1);
...
function imprimirdetalle($fpdf, $conexion)
{
    ...
    $fpdf->SetFont('Arial', 'B', 15);
    $fpdf->Cell(190, 20, "Precio Total : $".number_format($pago,2,',','.'), 1, 0, 'R', 1);
}
?>
